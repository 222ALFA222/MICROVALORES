                            ...
                            <table class="table table-striped table-hover">
                                <thead class="thead">
                                    <tr>
                                        ...
                                        <th>ACCIONES EN VENTA</th>
                                        <th>PRECION POR ACCION</th>
                                ...
                                <tbody>
                                    @foreach ($categorias as $categoria)
                                        <tr>
                                            ...
                                            <td>{{ $categoria->valuacion }}</td>
                                            <td>{{ $categoria->numero_de_acciones }}</td>
                                            <td>{{ $categoria->acciones_en_venta }}</td>
                                            <td>{{ $categoria->precio_por_accion }}</td>
